  ...
  <header class="hero w-[100%]" role="banner" aria-label="Ozow payment header">
    ...
    <div class="hero__content px-4">
      <div class="brand" aria-label="Ozow">
       ...
       <!-- Ozow circular logomark — always visible -->
      ...
      <div class="actions">
        ...
        <button v-if="(paymentsStore as any).cancelable" class="btn-circle btn-circle--bordered" aria-label="Cancel" @click="userCancel">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
