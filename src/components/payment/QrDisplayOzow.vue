<template>
  <div class="w-full flex flex-col pb-6">
    <p class="instructions text-left mt-4">Scan the QR code with {{ wallet.scanner }} to complete payment</p>
    <div v-if="paymentRequestQrUrl && !qrLoadError" class="center flex justify-center">
    ...
    <p class="instructions mt-4">Payment link expires in 2 minutes</p>
  </div>
</template>
